...
TEST(INDEXATION_OPERATOR_OVERLOAD,
     CORRECT_INPUT_GET_VALUE_OF_ELEMENT_BY_INDEXATION) {
...
TEST(INDEXATION_OPERATOR_OVERLOAD,
     CORRECT_INPUT_ASSIGNMENT_OF_VALUE_BY_INDEXATION) {
  double *test1 = new double[4]{2, 2, 2, 2};
...
TEST(INDEXATION_OPERATOR_OVERLOAD,
     INCORRECT_INPUT_INDEXED_ELEMENT_IS_OUT_OF_BOUNDS) {
  double *test1 = new double[4]{2, 2, 2, 2};
...
TEST(ADDICTION_ASSIGNMENT_OPERATOR_OVERLOAD,
     INCORRECT_INPUT_DIFFERENT_MATRIX_DIMENSIONS) {
  double *test1 = new double[1]{1};
...
TEST(SUBTRACTION_OPERATOR_OVERLOAD,
     INCORRECT_INPUT_DIFFERENT_MATRIX_DIMENSIONS) {
  double *test1 = new double[1]{1};
...
TEST(SUBTRACTION_ASSIGNMENT_OPERATOR_OVERLOAD,
     INCORRECT_INPUT_DIFFERENT_MATRIX_DIMENSIONS) {
  double *test1 = new double[1]{1};
...
TEST(MULTIPLICATION_BY_MATRIX_OPERATOR_OVERLOAD,
...
TEST(ASSIGNMENT_BY_MULTIPLICATION_BY_MATRIX,
     INCORRECT_INPUT_NOT_VALID_MATRIX_DIMENSIONS_FOR_MULTIPLICATION) {
  double *test1 = new double[1]{1};
